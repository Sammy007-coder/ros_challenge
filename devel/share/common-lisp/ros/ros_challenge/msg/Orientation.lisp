...
(cl:defmethod cl:initialize-instance :after ((m <Orientation>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Orientation)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_challenge-msg:<Orientation> is deprecated: use ros_challenge-msg:Orientation instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <Orientation>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_challenge-msg:x-val is deprecated.  Use ros_challenge-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <Orientation>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_challenge-msg:y-val is deprecated.  Use ros_challenge-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'z-val :lambda-list '(m))
(cl:defmethod z-val ((m <Orientation>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_challenge-msg:z-val is deprecated.  Use ros_challenge-msg:z instead.")
  (z m))

(cl:ensure-generic-function 'w-val :lambda-list '(m))
(cl:defmethod w-val ((m <Orientation>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_challenge-msg:w-val is deprecated.  Use ros_challenge-msg:w instead.")
  (w m))
